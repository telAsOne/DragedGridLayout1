                       ...
                       <form class="video-comment">\
                            ...
                            <div class="setBox">\
                                <div class="group">\
                                    ...
                                    <label>大小：</label><input type="number" id="ziti" onchange="zitidaxiao()" name="fontSize" value="16" step="1" min="12" max="30"><span>像素</span>\
                                </div>\
                                <div class="group">\
                                    <label>位置：</label><input type="number" onchange="weizhi()" id="weizhi" name="top" value="10" step="1" min="3" max="53"><span>%</span>\
...
function weizhi(){
	var weizhi=document.getElementById("weizhi").value;
	if(weizhi>53){
		document.getElementById("weizhi").value=53;
	}
	if(weizhi<3){
		document.getElementById("weizhi").value=3;
	}
}
function zitidaxiao(){
	var ziti=document.getElementById("ziti").value;
	if(ziti>30){
		document.getElementById("ziti").value=30;
	}
	if(ziti<12){
		document.getElementById("ziti").value=12;
	}
}
