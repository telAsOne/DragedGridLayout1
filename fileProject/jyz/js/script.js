$(function () {
  ...
  $game_item.hover(function () {
    $gameImg.attr('style', 'background-image: url(/bilibiliThree/fileProject/jyz/images/cont/'+urlArr[$(this).index()]+')');
  }, function () {
    $gameImg.attr('style', '');
  });
  ...
  // 侧边导航跳转
  document.querySelector("#live-a").onclick = function(){ 
    document.querySelector("#live").scrollIntoView(true);  
  }
  
  document.querySelector("#animation-a").onclick = function(){ 
    document.querySelector("#animation").scrollIntoView(true);  
  }
  
  document.querySelector("#bangumi-a").onclick = function(){ 
    document.querySelector("#bangumi").scrollIntoView(true);  
  }
  document.querySelector("#china-a").onclick = function(){ 
    document.querySelector("#china").scrollIntoView(true);  
  }
  document.querySelector("#music-a").onclick = function(){ 
    document.querySelector("#music").scrollIntoView(true);  
  }
  document.querySelector("#dance-a").onclick = function(){ 
    document.querySelector("#dance").scrollIntoView(true);  
  }
  document.querySelector("#game-a").onclick = function(){ 
    document.querySelector("#game").scrollIntoView(true);  
  }
  document.querySelector("#technology-a").onclick = function(){ 
    document.querySelector("#technology").scrollIntoView(true);  
  }

  document.querySelector("#guichu-a").onclick = function(){ 
    document.querySelector("#guichu").scrollIntoView(true);  
  }
  
  document.querySelector("#life-a").onclick = function(){ 
    document.querySelector("#life").scrollIntoView(true);  
  }
  
  document.querySelector("#fasion-a").onclick = function(){ 
    document.querySelector("#fasion").scrollIntoView(true);  
  }
  
  document.querySelector("#gg-a").onclick = function(){ 
    document.querySelector("#gg").scrollIntoView(true);  
  }
  
  document.querySelector("#yule-a").onclick = function(){ 
    document.querySelector("#yule").scrollIntoView(true);  
  }
  
  document.querySelector("#movie-a").onclick = function(){ 
    document.querySelector("#movie").scrollIntoView(true);  
  }
  
  document.querySelector("#tv-a").onclick = function(){ 
    document.querySelector("#tv").scrollIntoView(true);  
  }
