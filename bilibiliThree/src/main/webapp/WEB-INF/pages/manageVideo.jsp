...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/fileProject/zch/font-awesome-4.7.0/css/font-awesome.min.css">
</head>
<body>

	<section>
		<p id="no-file">你还没有投过一个稿件("▔□▔)</p>
		<div class="videos"><img src="img/no-video.png" alt="loading"></div>
