	...
	<div id="bigDiv">
		...
		<aside id="uploadingMenu">
			...
			<button id="contributeButton">
				<a href="bi?iframeSrc=uploadVideo&src=uploading" style="color:white;font-size:15px;">投稿</a>
			</button>
			
			<div id="menuDiv">
				<ul class="menu">
					<li class="li-blue"><i class="fa fa-home fa-fw"></i> &nbsp;&nbsp;首页管理</li>
					<li class="li-blue"><i class="fa fa-clipboard fa-fw"></i> &nbsp;&nbsp;<a href="bi?iframeSrc=manageVideo&src=uploading" >内容管理</a></li>
		...
		<div id="uploadingDiv">
			<section id="section">
				<iframe id="iframe" scrolling="no" src="${pageContext.request.contextPath}/${iframeSrc}" frameborder="s" height="900px" width="1030px"></iframe>
			</section>
		</div>
